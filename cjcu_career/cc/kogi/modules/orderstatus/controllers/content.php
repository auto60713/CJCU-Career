...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Orderstatus.Content.View');
	...
	*/
	public function index() 
	{
		...
		Template::set('toolbar_title', lang('orderstatus_manage'));
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Orderstatus.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_orderstatus())
			{
				...
				Template::redirect(SITE_AREA .'/content/orderstatus');
			}
			else 
			{
		...
		Template::set('toolbar_title', lang('orderstatus_create') . '訂單狀態');
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Orderstatus.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/orderstatus');
		}
		...
		Template::set('toolbar_title', lang('orderstatus_edit') . '訂單狀態');
		Template::render();		
	}
	...
	*/
	...
	{	
		$this->auth->restrict('Orderstatus.Content.Delete');

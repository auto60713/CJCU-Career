...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Orderstatus.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Orderstatus.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_orderstatus())
			{
				...
				Template::redirect(SITE_AREA .'/developer/orderstatus');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Orderstatus.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/orderstatus');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Orderstatus.Developer.Delete');

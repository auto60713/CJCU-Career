...
<fieldset>
	<legend>說明</legend>
	<div>請輸入您要編輯的名稱以及描述這個狀態。<span style="color:red;">＊表示必填</span></div>
</fieldset>
<hr/>
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="編輯" /> 或 <?php echo anchor(SITE_AREA .'/content/orderstatus', lang('orderstatus_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/orderstatus/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('orderstatus_delete_confirm'); ?>')"><?php echo lang('orderstatus_delete_record'); ?></a>

<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/developer/itmes/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/itmes/edit/'. $record->id, lang('itmes_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>

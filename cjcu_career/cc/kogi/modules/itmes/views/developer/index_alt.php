...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('itmes_no_records'); ?> <?php echo anchor(SITE_AREA .'/developer/itmes/create', lang('itmes_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/developer/itmes/create')?>"><?php echo lang('itmes_create_new_button');?></a>
...
foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/itmes/edit/'. $record->id, lang('itmes_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>

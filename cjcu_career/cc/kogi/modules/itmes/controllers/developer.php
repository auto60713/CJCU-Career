...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Itmes.Developer.View');
	...
	*/
	public function index() 
	{
		...
		Template::set('toolbar_title', "Manage itmes");
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Itmes.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_itmes())
			{
				...
				Template::redirect(SITE_AREA .'/developer/itmes');
			}
			else 
			{
		...
		Template::set('toolbar_title', lang('itmes_create') . ' itmes');
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Itmes.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/itmes');
		}
		...
		Template::set('toolbar_title', lang('itmes_edit') . ' itmes');
		Template::render();		
	}
	...
	*/
	...
	{	
		$this->auth->restrict('Itmes.Developer.Delete');

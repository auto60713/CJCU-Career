...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Itmes.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Itmes.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_itmes())
			{
				...
				Template::redirect(SITE_AREA .'/reports/itmes');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Itmes.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/itmes');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Itmes.Reports.Delete');

...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Catalog.Settings.View');
	...
	*/
	public function index() 
	{
		...
		Template::set('toolbar_title', "文章分類管理");
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Catalog.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_catalog())
			{
				...
				Template::redirect(SITE_AREA .'/settings/catalog');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Catalog.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/catalog');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Catalog.Settings.Delete');

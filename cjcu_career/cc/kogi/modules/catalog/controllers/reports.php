...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Catalog.Reports.View');
	...
	*/
	public function index() 
	{
		...
		Template::set('toolbar_title', "Manage catalog");
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Catalog.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_catalog())
			{
				...
				Template::redirect(SITE_AREA .'/reports/catalog');
			}
			else 
			{
		...
		Template::set('toolbar_title', lang('catalog_create') . ' catalog');
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Catalog.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/catalog');
		}
		...
		Template::set('toolbar_title', lang('catalog_edit') . ' catalog');
		Template::render();		
	}
	...
	*/
	...
	{	
		$this->auth->restrict('Catalog.Reports.Delete');

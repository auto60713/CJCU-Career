...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('catalog_no_records'); ?> <?php echo anchor(SITE_AREA .'/developer/catalog/create', lang('catalog_create_new'), array("class" => "ajaxify")); ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/developer/catalog/create'); ?>"><?php echo lang('catalog_create_new_button'); ?></a>
...
foreach ($records as $record) :; ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/catalog/edit/'. $record->id, lang('catalog_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>

<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/developer/catalog/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) :; ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/catalog/edit/'. $record->id, lang('catalog_edit'), ''); ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>

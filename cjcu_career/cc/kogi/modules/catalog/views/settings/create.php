...
<br>
<div>
        <?php echo form_label('分類名稱', 'catalog'); ?> <span class="required">*</span>
...
<hr/>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="新增" /> 或 <?php echo anchor(SITE_AREA .'/settings/catalog', lang('catalog_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

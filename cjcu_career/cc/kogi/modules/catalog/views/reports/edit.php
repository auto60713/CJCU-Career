...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit catalog" /> or <?php echo anchor(SITE_AREA .'/reports/catalog', lang('catalog_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/catalog/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('catalog_delete_confirm'); ?>')"><?php echo lang('catalog_delete_record'); ?></a>

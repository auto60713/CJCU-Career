<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/content/shipment/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) :; ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/content/shipment/edit/'. $record->id, lang('shipment_edit'), ''); ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>

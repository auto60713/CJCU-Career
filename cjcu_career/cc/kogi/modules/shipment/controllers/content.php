...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Shipment.Content.View');
	...
	*/
	public function index() 
	{
		...
		Template::set('toolbar_title', "管理配送方式");
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Shipment.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_shipment())
			{
				...
				Template::redirect(SITE_AREA .'/content/shipment');
			}
			else 
			{
		...
		Template::set('toolbar_title', lang('shipment_create') . '配送方式');
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Shipment.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/shipment');
		}
		...
		Template::set('toolbar_title', lang('shipment_edit') . '配送方式');
		Template::render();		
	}
	...
	*/
	...
	{	
		$this->auth->restrict('Shipment.Content.Delete');

...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Shipment.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Shipment.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_shipment())
			{
				...
				Template::redirect(SITE_AREA .'/reports/shipment');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Shipment.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/shipment');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Shipment.Reports.Delete');

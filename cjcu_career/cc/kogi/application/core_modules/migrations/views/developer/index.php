...
<?php else : ?>
	...
	<div id="tabs">
		<ul>
			<li><a href="#app-tab">應用程式</a></li>
			<li><a href="#mod-tab">模組</a></li>
			<li><a href="#core-tab">Bonfire框架</a></li>
		</ul>
		...
		<div id="mod-tab">
			...
			<?php if (isset($mod_migrations) && is_array($mod_migrations)) :?>
				<table>
					<thead>
						<tr>
							<th style="vertical-align: bottom;">模組</th>
							<th style="width: 6em">已安裝版本</th>
							<th style="width: 6em">最新版</th>
							<th></th>
							<th></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td style="width: 10em">
								<input type="submit" name="submit" value="執行指定動作" />
							</td>
						</tr>
						</form>
						<?php endforeach; ?>

<style>
.list-view .permission_set {cursor: pointer; border-bottom: 1px solid #CCCCCC; background: #F5F5F5; vertical-align: middle; font-size: 11px; }
...
<div class="view split-view">
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<h2><?php echo lang('permissions_permissions');?></h2>
			<table>
				<thead>

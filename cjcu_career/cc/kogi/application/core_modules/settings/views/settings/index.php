...
<br/>
	...
	<!--<div>
		<label for="term_begins"><?php echo lang('bf_term_begins') ?></label>
		<script>head.ready(function() {$('#date').datepicker({dateFormat : 'yy-mm-dd'	});	});</script>
		<input type="text" id="date" name="term_begins" value="<?php echo isset($settings['term_begins']) ? $settings['term_begins'] : set_value('term_begins') ?>" />
	</div>-->

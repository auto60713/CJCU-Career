<h2><span style="font-weight: normal">目前檢視的檔案為:</span> <?php echo $log_file_pretty; ?></h2>
...
<?php else : ?>
	...
	<?php if (has_permission('Bonfire.Logs.Manage')) : ?>
		...
		<div class="box delete rounded">
			<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/developer/logs/purge/'.$log_file); ?>" onclick="return confirm('您確定要刪除此紀錄?')"><?php echo lang('log_delete1_button'); ?></a>

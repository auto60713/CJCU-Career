...
<?php echo form_open('login'); ?>
	...
	<label for="login_value"><?php echo $this->settings_lib->item('auth.login_type') == 'both' ? '帳號/Email' : ucwords($this->settings_lib->item('auth.login_type')) ?></label>
	...
	<div class="submits">
		<input type="submit" name="submit" id="submit" value="登入" tabindex="5" />	
	</div>
